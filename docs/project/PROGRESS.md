...
- ⏭️ **NEXT:** synthetic COD data generator — `src/data/generate_synthetic_cod.py`

## Phase checklist (compressed ~10-day plan)
- [ ] **P1 — Data:** synthetic COD generator + real pincode grounding + EDA
